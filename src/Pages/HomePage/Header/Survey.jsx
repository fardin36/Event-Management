...
const Survey = () => {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center p-5 bg-black">
            <h1 className="text-center font-bold text-4xl mb-2" data-aos="fade-up" data-aos-duration="1000">eSports & Gaming</h1>
            <h4 className="text-center text-xl md:text-2xl text-[#FF1E56] mb-10 lg:mb-28" data-aos="fade-up" data-aos-duration="1000">Overview of this world in numbers</h4>
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-7 lg:gap-20" data-aos="fade-up" data-aos-duration="1000">
                <div>
